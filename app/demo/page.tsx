        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center mb-8 gap-2">
            <div className="flex flex-wrap gap-2 bg-gray-100 dark:bg-gray-800 p-1 rounded-lg">
              ...
              <Button className="cursor-pointer px-6 py-2 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold shadow-lg hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
              {t.madeButton}
              </Button>
            </div>
          </div>
